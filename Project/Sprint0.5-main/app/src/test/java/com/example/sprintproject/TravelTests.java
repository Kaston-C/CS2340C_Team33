...
public class TravelTests {
    ...
    public void testingTravelPostDetails() {
        TravelPost travelPost = new TravelPost("user1", "Spain", "2024-11-01", "2024-11-10", "Hotel", "Coffee Shop", "Train", "Fun!");
    ...
    public void testingTravelListAdding() {
        ...
        TravelPost travels = new TravelPost("user1", "Spain", "2024-09-01", "2024-09-10", "Hotal", "Donut Shop", "Bus", "Fun Trip!");
        travel.add(travels);
