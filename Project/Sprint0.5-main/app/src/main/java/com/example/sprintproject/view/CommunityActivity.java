...
public class CommunityActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        destinationButton.setOnClickListener(v -> startActivity(new Intent(CommunityActivity.this, DestinationActivity.class)));

        ImageButton diningButton = findViewById(R.id.dining_button);
        diningButton.setOnClickListener(v -> startActivity(new Intent(CommunityActivity.this, DiningActivity.class)));

        ImageButton accommodationButton = findViewById(R.id.accommodation_button);
        accommodationButton.setOnClickListener(v -> startActivity(new Intent(CommunityActivity.this, AccommodationActivity.class)));
